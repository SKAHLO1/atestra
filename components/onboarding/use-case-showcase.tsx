...
const useCases = [
    {
        ...
        attestra: "AI-verified attendance on Flow blockchain with Filecoin storage keeps credentials verifiable",
    ...
    },
    {
        ...
        attestra: "AI-verified badge records on Flow protect organizational data while proving attendance",
    ...
    },
    {
        ...
        attestra: "AI-verified participation on Flow — reveal your credentials only when it benefits you",
    ...
    },
    {
        ...
        attestra: "Access gated communities via badge ownership on Flow while maintaining pseudonymity",
            ...
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-12">
                    ...
                    <p className="text-xl font-semibold text-gray-900 dark:text-gray-400 max-w-2xl mx-auto">
                        Not all attendance should be public. Here's where Attestra's AI-verified, blockchain-backed approach makes a real difference.
                    </p>
                </div>
                            ...
                            <CardContent>
                                <div className="space-y-3">
                                    ...
                                    <div className="p-3 rounded-lg bg-green-500/10 border border-green-500/20">
                                        <p className="text-sm font-medium text-green-600 dark:text-green-400 mb-1">✅ Attestra</p>
                                        <p className="text-xs text-gray-900 dark:text-black-200">{useCase.attestra}</p>
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-6">
                        ...
                        <div className="flex-1 text-center md:text-left">
                            ...
                            <p className="text-gray-900 dark:text-gray-100">
                                ...
                                Attestra badges are minted <span className="font-semibold text-primary">only when claimed</span> with AI verification —
