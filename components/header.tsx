        ...
        <div className="container mx-auto h-full flex items-center justify-center">
          <div className="flex items-center gap-2 animate-in fade-in slide-in-from-top-4 duration-1000">
            ...
            <p className="text-[10px] md:text-xs font-bold text-white tracking-wider uppercase">
              Welcome to <span className="text-blue-400">Attestra</span>! AI-Verified Attendance on Flow &amp; Filecoin
            </p>
            <Sparkles className="w-3 h-3 text-blue-400" />
          </div>
        </div>
      ...
      <div className="border-b border-gray-200">
        <div className="container mx-auto px-4 py-0.5 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <span className="text-2xl font-black tracking-tighter text-gray-900 hover:scale-105 transition-transform duration-300 cursor-pointer inline-block">Attestra</span>
          </div>
          ...
          <div className="flex items-center gap-3">
            <div className="hidden md:flex items-center gap-1.5 px-2 py-0.5 text-[10px] rounded-full bg-green-50 border border-green-200">
              ...
              <span className="font-medium text-green-700">Flow Testnet</span>
            </div>
            <HamburgerMenu />
          </div>
        </div>
